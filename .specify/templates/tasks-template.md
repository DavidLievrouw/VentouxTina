...
**Tests**: Test tasks are REQUIRED by constitution for behavior-changing work. Include unit and
integration tests for every user story unless a documented exception is approved.
...
- [ ] T004 [P] Configure container build and runtime parity checks
...
- [ ] T010 Setup environment configuration and secrets management
- [ ] T011 Define canonical route/progress invariants shared by map and log features
...
- [ ] T012 [P] [US1] Unit tests for domain logic in tests/unit/test_[name].py
...
- [ ] T021 [P] [US2] Unit tests for domain logic in tests/unit/test_[name].py
...
- [ ] T028 [P] [US3] Unit tests for domain logic in tests/unit/test_[name].py
...
- [ ] TXXX [P] Additional unit tests for new/changed domain logic in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Container image scan and runtime verification
